...
export default function ProjectCard(props:ProjectItem){
    return (
        <div>
            <div class="animate-bounceIn flex flex-col items-center h-full mx-2 px-4 bg-green-200 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-40 border border-gray-100 hover:border-gray-300 hover:drop-shadow-md transition">
                <div>
